...
import DataFiscal from "../Acumulado_archivos/data.jpg";
      ...
      <div className="lay">
                    ...
                    <section className="col-desksm-6 col-deskxl-5">
                        <section className="row ">
                            <section className="col-desksm-12 col-deskxl-6 link">
                                <a href="https://policies.google.com/terms?hl=es-419" target="_blank" className="condition">Condiciones</a>
                            </section>
                            <section className="col-desksm-12 col-deskxl-6 link">
                                <a href="https://policies.google.com/privacy?hl=es-419" target="_blank" className="private">Privacidad</a>
                            </section>
                        </section>
                    </section>
                </section>
        ...
        <section className="row footer-copyright">
          <section className="col-desksm-6 col-desk-6 footer-copyright__fiscal">
            <p>
              <img
                src="Acumulado_archivos/gda.jpg"
                alt="gda"
                className="img_gda"
              />
            ...
            {/*
                  <section className="row fiscal_row">
                    ...
                    <section className="col-3 col-desksm-1 col-1 data-fiscal">
                        <a href="https://serviciosweb.afip.gob.ar/clavefiscal/qr/publicInfoD.aspx" target="_blank"><img src="https://static.glanacion.com/v2/ln/img/data.jpg" alt="" className="img_data-fiscal"></a>
                    </section>
                </section>
            */}
          </section>
